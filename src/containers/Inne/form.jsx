...
//   const [posterId, setPosterId] = useState(video);
...
//   const handlePosterId = (event) => setPosterId(event.target.value);
//   const handleYearChange = (event) => setYear(event.target.value);
//   //   const handleDateChange = (event) => setDate(event.target.value);

//   const lastArrayId = (array) =>
//     Object.values(array)[Object.values(array).length - 1].id + 1;

//   const arrayId =
//     (posterType === 'game' && lastArrayId(games)) || lastArrayId(video);
...
//     date: ''
//   };
//   const showObject = () => console.log(newPoster, arrayId);
